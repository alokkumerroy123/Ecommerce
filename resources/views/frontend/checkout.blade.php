...
<div class="container">
  ...
  <div class="col-md-6 mt-5">
    <h3 class="text-center mt-3">Your Information</h3>
    ...
    <form action="{{route('checkout')}}" method="post">
      ...
      <div class="mb-3">
        ...
        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp"  placeholder="Enter your email" value="{{auth()->user()->email}}">
        @error('email')
        <p class="text-danger">{{$message}}</p>
        @enderror
      </div>
      ...
      <div class="mb-3">
        <label for="txn_id" class="form-label">Tnx_id</label>
        <input type="text" name="txn_id" class="form-control @error('txn_id') is-invalid @enderror" id="txn_id" aria-describedby="emailHelp" required placeholder="Enter youre Txn id" value="{{old('txn_id')}}">
        @error('txn_id')
        <p class="text-danger">{{$message}}</p>
        @enderror
      </div>
